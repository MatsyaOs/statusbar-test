...
int main(int argc, char *argv[])
{
    ...
    const char *uri = "Matsya.StatusBar";
    ...
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/matsya-statusbar/translations/").arg(QLocale::system().name());
    ...
    if (!QDBusConnection::sessionBus().registerService("com.matsya.Statusbar")) {
        return -1;
    }
